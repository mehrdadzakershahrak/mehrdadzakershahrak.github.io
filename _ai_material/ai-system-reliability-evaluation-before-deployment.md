...
For document-heavy use cases where source review is the immediate bottleneck, build the review path into the system itself: citations, source pages, no-answer behavior, and evaluation should be visible before launch.
