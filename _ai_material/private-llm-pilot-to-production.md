...
After retrieval is stable, test the generated answer for faithfulness, completeness, refusal behavior, and citation correctness. For document review workflows where page-level verification matters, carry page metadata and reviewer links through the full system.
